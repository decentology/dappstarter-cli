...
class DappStarterService {
  ...
  static Future<List<Manifest>> getManifest() async {
    ...
    TextPen()
      ..red()
      ..text('${Icon.HEAVY_BALLOT_X} Bad response from Dappstarter manifest.')
          .print();
    return null;
  }
  ...
  static Future<void> postSelections(
    ...
    if (response.statusCode == 201) {
      try {
        ...
        TextPen()
          ..red()
          ..text('${Icon.HEAVY_BALLOT_X} Unable to extract project package.')
              .print();
      }
    } else {
      TextPen()
        ..red()
        ..text('${Icon.HEAVY_BALLOT_X} Bad response generating dapp.').print();
    }
  }
}
